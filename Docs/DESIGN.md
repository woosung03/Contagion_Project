...
| `UpgradeTree.uss` | Fullscreen, research-row/branch-board | 17/21.1절 소비처. 로컬 중복 정의 없음(tactical-panel/corner-cut/data-row/data-label/data-value 전부 Tactical.uss 참조로 정리 완료, UI Audit 1~5차). `data-value--locked/available/active/maxed`(노드 상태 축, 14절)만 로컬 유지 |
...
| 사용 화면 | UpgradeTree(Research Database v2) |
